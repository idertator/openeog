...
def process_study(study: Study):
    ...
    for index, test in enumerate(study):
        ...
        # Fixing timing
        SAMPLES_TO_CUT_FIRST_CALIBRATION = 222
        if  index == 0:
        ...
        print(f"Tamaño hor_channel: {len(test._hor_channel)}, Tamaño hor_stimuli: {len(test._hor_stimuli)}")
        print(f"Tamaño ver_channel: {len(test._ver_channel)}, Tamaño ver_stimuli: {len(test._ver_stimuli)}")
